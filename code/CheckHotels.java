...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        ...
        String[] text = new String[]{"JW Marriott Hotel","Madarian Oriental Hotel","The Taj Hotel","Four Season Hotel","Raddisson Blue Hotel","Classio Hotel","Breeze Blow Hotel","River View Hotel","Diamond Plaza Hotel","The Sparkle Hotel"};
        try{
           for(int i =0;i<=9;i++){
